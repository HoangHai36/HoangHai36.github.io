(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["articleModule-article-module"], {
            ...
            var AngularEditorToolbarComponent = /** @class */ (function () {
                ...
                AngularEditorToolbarComponent.prototype.insertUrl = function () {
                    ...
                    if (selection && selection.commonAncestorContainer.parentElement.nodeName === 'A') {
                        /** @type {?} */
                        var parent = ( /** @type {?} */(selection.commonAncestorContainer.parentElement));
                        if (parent.href !== '') {
                            url = parent.href;
                        }
                    }
                 ...
                 * @return {?}
                 */
                AngularEditorToolbarComponent.prototype.fileReset = function () {
                ...
                AngularEditorToolbarComponent.prototype.isButtonHidden = function (name) {
                    ...
                    /** @type {?} */
                    var result;
                    for (var _i = 0, _a = this.hiddenButtons; _i < _a.length; _i++) {
                        var arr = _a[_i];
            ...
            var AngularEditorComponent = /** @class */ (function () {
                ...
                AngularEditorComponent.prototype.onTextAreaBlur = function (event) {
                    ...
                    if (event.relatedTarget !== null) {
                        /** @type {?} */
                        var parent = (( /** @type {?} */(event.relatedTarget))).parentElement;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArticlePageComponent = /** @class */ (function () {
                function ArticlePageComponent(articleService, route, router) {
                    var _this = this;
                    ...
                    this.route.params.subscribe(function (param) {
                        _this.img = localStorage.getItem('image');
                ...
                ArticlePageComponent.prototype.onChangeFollow = function (following) {
                    this.article.author.following = following;
                };
                ArticlePageComponent.prototype.emitChangeFavorite = function (favorited) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _kolkov_angular_editor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @kolkov/angular-editor */ "./node_modules/@kolkov/angular-editor/fesm2015/kolkov-angular-editor.js");
            var articleRoutes = [
                {
                    path: '', children: [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _article_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../article.service */ "./src/app/articleModule/article.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var CommentArticleComponent = /** @class */ (function () {
                function CommentArticleComponent(articleService, route) {
                    var _this = this;
                    this.articleService = articleService;
                    this.route = route;
                    this.textBody = '';
                    ...
                    this.route.params.subscribe(function (param) {
                        _this.slug = param['slug'];
                        _this.img = localStorage.getItem('image');
                        _this.articleService.getCommentArticle(_this.slug).subscribe(function (data) {
                            _this.listComment = data['comments'];
                        });
                    });
                }
                CommentArticleComponent.prototype.ngOnInit = function () {
                };
                //comment
                CommentArticleComponent.prototype.postNewComment = function () {
                    var _this = this;
                    if (localStorage.getItem('token')) {
                ...
                CommentArticleComponent.prototype.deleteComment = function (id, index) {
                    var _this = this;
                    if (this.isLogin) {
                ...
                return CommentArticleComponent;
            }());
            CommentArticleComponent.ctorParameters = function () { return [
                { type: _article_service__WEBPACK_IMPORTED_MODULE_2__["ArticleService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditorArticleComponent = /** @class */ (function () {
                function EditorArticleComponent(articleService, appService, route, router, fb) {
                    var _this = this;
                    this.articleService = articleService;
                ...
                EditorArticleComponent.prototype.ngOnInit = function () {
                };
                EditorArticleComponent.prototype.pushTab = function (event) {
                    event.stopPropagation();
                ...
                EditorArticleComponent.prototype.postArticle = function () {
                    var _this = this;
                    ...
                    if (!this.check) {
                        this.articleService.postNewArticle(this.newArticle).subscribe(function (data) {
                            _this.router.navigate(['/article/', data['article']['slug']]);
                        }, function (err) {
                            _this.errNewArticle = _this.appService.getError(err);
                        });
                    }
                    else {
                ...
                EditorArticleComponent.prototype.removetab = function (index) {
                    this.tagList.splice(index, 1);
                };
                return EditorArticleComponent;
            }());
            EditorArticleComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=articleModule-article-module-es5.js.map
//# sourceMappingURL=articleModule-article-module-es5.js.map