...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.toggleSetting = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchVideoComponent = /** @class */ (function () {
                function SearchVideoComponent(apiService, router) {
                    this.apiService = apiService;
                    this.router = router;
                ...
                SearchVideoComponent.prototype.ngOnInit = function () {
                    ...
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this.search.nativeElement, "keyup")
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(this.setting.debounce ? this.setting.debounce : 500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (event) { return event.target.value; }))
                        .subscribe(function (val) {
                        _this.pageSize = _this.setting.pageSize ? _this.setting.pageSize : 5;
                        _this.router.navigate([""]);
                        _this.value = val;
                        _this.toggle = true;
                        _this.keyAPI = sessionStorage.getItem("key");
                        _this.apiService.getDataApi(val, _this.setting.pageSize, _this.keyAPI).subscribe(function (data) {
                            if (data) {
                                _this.value = val;
                                _this.nextToken = data['nextPageToken'];
                                _this.listItem = data['items'];
                                _this.length = data['pageInfo'].totalResults;
                            }
                        }, function (err) {
                            if (err.status === 400) {
                ...
                SearchVideoComponent.prototype.nextPage = function (event) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!(event.pageIndex > event.previousPageIndex)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.apiService.getDataApiNext(this.value, this.nextToken, this.pageSize, this.keyAPI)];
                                case 1:
                                    data = _a.sent();
                                    ...
                                    return [3 /*break*/, 5];
                                case 2:
                                    if (!this.preToken) return [3 /*break*/, 4];
                                    return [4 /*yield*/, this.apiService.getDataApiPre(this.value, this.preToken, this.pageSize, this.keyAPI)];
                                case 3:
                                    data = _a.sent();
                                    this.listItem = data['items'];
                                    this.nextToken = data['nextPageToken'];
                                    ...
                                    return [3 /*break*/, 5];
                                case 4:
                                    this.apiService.getDataApi(this.value, this.pageSize, this.setting.keyAPI).subscribe(function (data) {
                                        _this.listItem = data['items'];
                                    });
                                    _a.label = 5;
                ...
                SearchVideoComponent.prototype.sortData = function (value) {
                    var _this = this;
                    this.apiService.sortDataYoutobe(this.value, this.pageSize, this.setting.keyAPI, value).subscribe(function (data) {
                        _this.listItem = data['items'];
                        console.log(data);
                    });
                };
            ...
            SearchVideoComponent.ctorParameters = function () { return [
                { type: _youtobe_api_service__WEBPACK_IMPORTED_MODULE_2__["YoutobeAPIService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewVideoComponent = /** @class */ (function () {
                function ViewVideoComponent(route, apiService) {
                    this.route = route;
                    this.apiService = apiService;
                    this.id = '';
                }
                ViewVideoComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (param) {
                        var key = sessionStorage.getItem("key");
                        _this.id = 'https://www.youtube.com/embed/' + param.id;
                        _this.apiService.getDataItem(param.id, key).subscribe(function (data) {
                            _this.dataItem = data['items'][0];
                            console.log(_this.dataItem);
                        });
                        _this.apiService.getView(param.id, key).subscribe(function (data) {
                            _this.dataView = data['items'][0].statistics;
                        });
                    });
                };
                return ViewVideoComponent;
            }());
            ViewVideoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var YoutobeAPIService = /** @class */ (function () {
                function YoutobeAPIService(http) {
                    this.http = http;
                }
                YoutobeAPIService.prototype.getDataApi = function (value, page, key) {
                ...
                YoutobeAPIService.prototype.sortDataYoutobe = function (value, page, key, order) {
                    return this.http.get(configHTTP.url, {
                        params: {
                            key: key,
                            part: configHTTP.part,
                ...
                YoutobeAPIService.prototype.getDataApiNext = function (value, nextPageToken, page, key) {
                    return this.http.get(configHTTP.url, {
                        params: {
                            key: key,
                            part: configHTTP.part,
                ...
                YoutobeAPIService.prototype.getDataApiPre = function (value, prevPageToken, page, key) {
                    return this.http.get(configHTTP.url, {
                        params: {
                            key: key,
                            part: configHTTP.part,
                ...
                YoutobeAPIService.prototype.getDataItem = function (id, key) {
                ...
                YoutobeAPIService.prototype.getView = function (id, key) {
                    return this.http.get('https://www.googleapis.com/youtube/v3/videos', {
                        params: {
                            key: key,
                            part: 'statistics',
                ...
                return YoutobeAPIService;
            }());
            YoutobeAPIService.ctorParameters = function () { return [
